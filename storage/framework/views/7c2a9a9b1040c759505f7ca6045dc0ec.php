...
<aside class="w-sidebar-width h-screen fixed left-0 top-0 bg-surface border-r-[0.5px] border-outline-variant py-page-padding hidden md:flex flex-col z-40">
    ...
    <nav class="flex-grow">
        <ul class="space-y-1">
            <li class="px-2">
                <a class="flex items-center gap-3 px-4 py-3 rounded text-secondary hover:bg-surface-container-low transition-colors group" href="<?php echo e(route('admin.dashboard')); ?>">
            ...
            <li class="px-2">
                ...
                <a class="flex items-center gap-3 px-4 py-3 rounded border-l-4 border-primary bg-primary-fixed text-primary font-bold transition-colors" href="<?php echo e(route('admin.events.index')); ?>">
                    <span class="material-symbols-outlined">event</span>
                    <span class="font-body-sm text-body-sm">Event Saya</span>
                </a>
            </li>
            <li class="px-2">
                <a class="flex items-center gap-3 px-4 py-3 rounded text-secondary hover:bg-surface-container-low transition-colors" href="<?php echo e(route('admin.scanner')); ?>">
                    <span class="material-symbols-outlined">qr_code_scanner</span>
                    <span class="font-body-sm text-body-sm">Scanner</span>
                </a>
            </li>
            <li class="px-2">
                <a class="flex items-center gap-3 px-4 py-3 rounded text-secondary hover:bg-surface-container-low transition-colors" href="<?php echo e(route('admin.finance')); ?>">
    ...
    <div class="mt-auto px-2">
        ...
        <form action="<?php echo e(route('logout')); ?>" method="POST" style="display:inline-block; width:100%;">
            <?php echo csrf_field(); ?>
...
<main class="md:ml-sidebar-width min-h-screen pb-24 md:pb-page-padding">
    ...
    <section class="max-w-max-container mx-auto px-0 md:px-page-padding md:pt-page-padding">
        <div class="relative w-full aspect-video md:rounded-xl overflow-hidden border-[0.5px] border-outline-variant bg-surface-container-high">
            <img alt="Event Banner" class="w-full h-full object-cover" src="<?php echo e($banner); ?>"/>
        ...
        <div class="px-page-padding md:px-0 mt-6 flex flex-col md:flex-row md:justify-between md:items-end gap-4">
            <div>
                <span class="text-tertiary font-label-md text-label-md bg-tertiary-fixed px-3 py-1 rounded-full"><?php echo e($event->category); ?></span>
                <h2 class="font-h1 text-h1 md:text-h1 mt-2 text-on-surface"><?php echo e($event->title); ?></h2>
                <div class="flex flex-wrap items-center gap-x-6 gap-y-2 mt-3 text-secondary">
                    <div class="flex items-center gap-2">
                        <span class="material-symbols-outlined text-[18px]">calendar_today</span>
                        <span class="font-body-sm text-body-sm"><?php echo e(\Carbon\Carbon::parse($event->start_date)->format('d F Y')); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="material-symbols-outlined text-[18px]">location_on</span>
                        <span class="font-body-sm text-body-sm"><?php echo e($event->venue_name ?? ($event->city ?? $event->location_type)); ?></span>
                    </div>
                </div>
            </div>
            <div class="flex gap-3">
                <a href="<?php echo e(route('event.show', $event->id_event)); ?>" target="_blank" class="flex items-center gap-2 px-4 py-2 bg-surface border border-outline-variant rounded-lg text-secondary hover:bg-surface-container-low transition-colors">
                    <span class="material-symbols-outlined text-[20px]">share</span>
                    <span class="font-label-md text-label-md">Public</span>
                </a>
                <a href="<?php echo e(route('admin.events.edit', $event->id_event)); ?>" class="flex items-center gap-2 px-6 py-2 bg-primary text-on-primary rounded-lg font-bold active:scale-95 transition-transform">
    ...
    <section class="max-w-max-container mx-auto mt-10 px-page-padding">
        ...
        <div id="tab-tiket" class="tab-content">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $event->ticketTiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <!-- Ticket Card -->
                <div class="bg-surface-container-lowest border-[0.5px] border-outline-variant rounded-xl p-6 transition-all hover:border-primary/40 group <?php echo e($isSoldOut ? 'border-dashed border-2 opacity-75' : ''); ?>">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h3 class="font-h3 text-h3 text-on-surface"><?php echo e($tier->tier_name); ?></h3>
                            <p class="font-caption text-caption text-secondary mt-1">Tier capacity: <?php echo e($tier->capacity ?: 'Unlimited'); ?></p>
                        </div>
                    ...
                    <div class="flex items-baseline gap-1 mb-6">
                        ...
                        <span class="font-h2 text-h2 text-primary font-black"><?php echo e(number_format($tier->price, 0, ',', '.')); ?></span>
                    </div>
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="font-body-sm text-body-sm text-secondary">Terjual</span>
                            <span class="font-label-md text-label-md text-on-surface font-bold"><?php echo e($sold); ?> / <?php echo e($tier->capacity ?: '∞'); ?></span>
                        </div>
                        <div class="w-full bg-surface-container-high h-2 rounded-full overflow-hidden">
                            <div class="bg-primary h-full rounded-full <?php echo e($isSoldOut ? 'bg-error w-full' : ''); ?>" style="width: <?php echo e($pct); ?>%;"></div>
                        </div>
            ...
            <div class="flex flex-col md:flex-row gap-stack-md mb-stack-lg items-center">
                ...
                <div class="flex gap-stack-sm w-full md:w-auto">
                    <select class="flex-1 md:flex-none px-4 py-2.5 bg-surface-container-low border-[0.5px] border-outline-variant rounded-lg font-body-sm focus:outline-none focus:border-primary">
                        ...
                        <?php $__currentLoopData = $event->ticketTiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option><?php echo e($tier->tier_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y-[0.5px] divide-outline-variant">
                            ...
                            <?php else: ?>
                                <?php $__currentLoopData = $ticketBuyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-surface-container-lowest transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 rounded-full border-[0.5px] border-outline-variant bg-surface-container flex items-center justify-center text-primary font-bold">
                                                <?php echo e(strtoupper(substr($tb->user->full_name ?? 'G', 0, 1))); ?>

                                            </div>
                                            <span class="font-bold text-on-surface"><?php echo e($tb->user->full_name ?? 'Guest'); ?></span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-secondary"><?php echo e($tb->user->email ?? '-'); ?></td>
                                    <td class="px-6 py-4">
                                        <span class="px-2 py-0.5 rounded-full text-caption bg-surface-container-high text-secondary font-bold">
                                            <?php echo e($tb->ticketTier->tier_name ?? 'Tiket'); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-secondary"><?php echo e($tb->created_at->format('d M Y, H:i')); ?></td>
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center flex-col items-center gap-1">
                                            <?php if($tb->payment_status === 'success'): ?>
                                            ...
                                            <?php elseif($tb->payment_status === 'pending'): ?>
                                            ...
                                            <?php else: ?>
                                                <span class="px-3 py-1 rounded-full text-caption bg-surface-container text-secondary font-bold flex items-center gap-1">
                                                    <?php echo e(ucfirst($tb->payment_status)); ?>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-end gap-2">
                                            <form action="<?php echo e(route('admin.events.tickets.toggle-checkin', [$event->id_event, $tb->id])); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <?php if($tb->payment_status === 'success'): ?>
                                            <button type="button" class="p-2 text-error hover:bg-error-container/20 rounded transition-colors" onclick="openRefundModal('<?php echo e($tb->id); ?>', '<?php echo e(addslashes($tb->user->full_name ?? 'Guest')); ?>', '<?php echo e($tb->gross_amount); ?>')" title="Refund 93%">
                                ...
                                <tr class="hover:bg-surface-container-low transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span class="font-medium"><?php echo e($tenant->full_name); ?></span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-secondary">Tenant</td>
                                    <td class="px-6 py-4 font-medium">Rp <?php echo e(number_format($sales, 0, ',', '.')); ?></td>
                                    <td class="px-6 py-4 text-on-surface-variant">
                                        Rp <?php echo e(number_format($cutAmount, 0, ',', '.')); ?> 
                                        <span class="text-caption bg-surface-container px-1.5 py-0.5 rounded ml-1">(<?php echo e($tenantCutPct); ?>%)</span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <?php if(!$wd): ?>
                                        ...
                                        <?php elseif($wd->status === 'pending_admin' || $wd->status === 'pending_superadmin' || $wd->status === 'pending'): ?>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <?php if($wd && $wd->status === 'pending_admin'): ?>
                                            <form action="<?php echo e(route('admin.events.withdraw.approve', [$event->id_event, $wd->id])); ?>" method="POST" class="inline">
                                                <?php echo csrf_field(); ?>
            ...
            <div class="bg-primary-fixed/30 border-[0.5px] border-primary/20 rounded-xl p-6 flex items-center justify-between mb-8">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 class="font-h3 text-on-primary-fixed-variant">Total Tenant Cut masuk ke pendapatan event: <span class="font-bold">Rp <?php echo e(number_format($tenantCut, 0, ',', '.')); ?></span></h3>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-white rounded-xl border-[0.5px] border-outline-variant p-6 h-fit">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center py-2 border-b-[0.5px] border-outline-variant border-dashed">
                            ...
                            <span class="text-body-sm font-medium text-on-surface">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b-[0.5px] border-outline-variant border-dashed">
                            <span class="text-body-sm text-secondary">Biaya Platform (<?php echo e($feePercent ?? 10); ?>%)</span>
                            <span class="text-body-sm font-medium text-error">–Rp <?php echo e(number_format($platformFee, 0, ',', '.')); ?></span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b-[0.5px] border-outline-variant border-dashed">
                            <span class="text-body-sm text-secondary">Potongan Tenant</span>
                            <span class="text-body-sm font-medium text-tertiary">+Rp <?php echo e(number_format($tenantCut, 0, ',', '.')); ?></span>
                        </div>
                        <div class="flex justify-between items-center pt-4">
                            <span class="text-body-lg font-bold text-on-surface">Total Pendapatan Bersih</span>
                            <span class="text-h2 font-black text-primary">Rp <?php echo e(number_format($netIncome, 0, ',', '.')); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-surface-container-low rounded-xl border-[0.5px] border-outline-variant p-6 flex flex-col justify-between">
                    <div>
                        ...
                        <h4 class="text-h2 font-black text-on-surface mb-2">Rp <?php echo e(number_format($sisaBisaDitarik, 0, ',', '.')); ?></h4>
                ...
                <div class="lg:col-span-3 bg-white rounded-xl border-[0.5px] border-outline-variant overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y-[0.5px] divide-outline-variant">
                                <?php $__empty_1 = true; $__currentLoopData = $eventWithdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-surface-container-lowest transition-colors">
                                    <td class="px-6 py-4 text-body-sm text-on-surface"><?php echo e($wd->created_at->format('d M Y, H:i')); ?></td>
                                    <td class="px-6 py-4 text-body-sm text-secondary"><?php echo e($wd->order_id); ?></td>
                                    <td class="px-6 py-4 text-body-sm font-bold text-on-surface">Rp <?php echo e(number_format($wd->amount, 0, ',', '.')); ?></td>
                                    <td class="px-6 py-4">
                                        <?php if($wd->status === 'success'): ?>
                                        ...
                                        <?php elseif($wd->status === 'pending_superadmin' || $wd->status === 'pending_admin' || $wd->status === 'pending'): ?>
...
<nav class="md:hidden fixed bottom-0 w-full z-50 bg-surface border-t-[0.5px] border-outline-variant flex justify-around items-center h-16 pb-safe">
    <a class="flex flex-col items-center gap-1 text-secondary" href="<?php echo e(route('admin.dashboard')); ?>">
        <span class="material-symbols-outlined text-[24px]">grid_view</span>
        <span class="font-label-md text-label-md">Dashboard</span>
    </a>
    <a class="flex flex-col items-center gap-1 text-primary font-bold" href="<?php echo e(route('admin.events.index')); ?>">
    ...
    <a class="flex flex-col items-center gap-1 text-secondary" href="<?php echo e(route('admin.scanner')); ?>">
    ...
    <a class="flex flex-col items-center gap-1 text-secondary" href="<?php echo e(route('admin.finance')); ?>">
        ...
        <div class="p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <p class="font-bold text-on-surface"><?php echo e($event->title); ?></p>
                </div>
                <div>
...
<script>
    ...
    function openRefundModal(transactionId, participantName, grossAmount) {
        ...
        const baseUrl = '<?php echo e(url("/admin/events/".$event->id_event."/tickets/")); ?>';
...
<div class="fixed inset-0 z-[100] hidden flex items-center justify-center bg-on-background/40 backdrop-blur-[2px] p-4" id="withdrawalModal">
    <div class="bg-white w-full max-w-md rounded-xl border border-outline-variant overflow-hidden animate-in fade-in zoom-in duration-200">
        <div class="p-6">
            ...
            <form action="<?php echo e(route('admin.events.withdraw.event', $event->id_event)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="bank_name" value="BCA">
                <input type="hidden" name="account_number" value="8829000000">
                <input type="hidden" name="amount" value="<?php echo e($sisaBisaDitarik); ?>">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input class="w-full bg-surface-container-low border-[0.5px] border-outline-variant rounded-lg py-3 pl-12 pr-4 text-h3 font-bold focus:outline-none focus:border-primary transition-colors" readonly="" type="text" value="<?php echo e(number_format($sisaBisaDitarik, 0, ',', '.')); ?>"/>
                    </div>
                </div>
...
<?php /**PATH D:\laragon\www\JVC26\gatemate\resources\views/admin/events/show.blade.php ENDPATH**/ ?>