...
<nav class="fixed left-0 top-0 h-screen w-[240px] flex flex-col py-stack-lg border-r border-outline-variant bg-surface z-40 hidden md:flex">
    ...
    <div class="flex flex-col flex-grow">
        <a class="flex items-center gap-3 px-gutter py-3 text-secondary hover:bg-surface-container-low transition-colors duration-200 font-label-md text-label-md" href="<?php echo e(route('admin.dashboard')); ?>">
            <span class="material-symbols-outlined" data-icon="dashboard">dashboard</span>
            Dashboard
        </a>
        <a class="flex items-center gap-3 px-gutter py-3 text-secondary hover:bg-surface-container-low transition-colors duration-200 font-label-md text-label-md" href="<?php echo e(route('admin.events.index')); ?>">
            <span class="material-symbols-outlined" data-icon="calendar_today">calendar_today</span>
            Event Saya
        </a>
        <a class="flex items-center gap-3 px-gutter py-3 border-l-4 border-primary bg-primary-fixed text-on-primary-fixed-variant font-bold font-label-md text-label-md" href="<?php echo e(route('admin.scanner')); ?>">
            <span class="material-symbols-outlined" data-icon="qr_code_scanner">qr_code_scanner</span>
            Scanner
        </a>
        <a class="flex items-center gap-3 px-gutter py-3 text-secondary hover:bg-surface-container-low transition-colors duration-200 font-label-md text-label-md" href="<?php echo e(route('admin.finance')); ?>">
    ...
    <div class="px-gutter mt-auto flex items-center gap-3">
        ...
        <div class="flex flex-col">
            <span class="font-label-md text-label-md font-bold text-on-surface"><?php echo e(auth()->user()->full_name ?? 'Admin Utama'); ?></span>
...
<nav class="fixed bottom-0 left-0 w-full z-50 md:hidden bg-surface border-t border-outline-variant flex justify-around items-center h-16">
    <a class="flex flex-col items-center justify-center text-secondary" href="<?php echo e(route('admin.dashboard')); ?>">
        <span class="material-symbols-outlined" data-icon="dashboard">dashboard</span>
        <span class="font-caption text-caption">Dashboard</span>
    </a>
    <a class="flex flex-col items-center justify-center text-secondary" href="<?php echo e(route('admin.events.index')); ?>">
        <span class="material-symbols-outlined" data-icon="event">event</span>
        <span class="font-caption text-caption">Events</span>
    </a>
    <a class="flex flex-col items-center justify-center text-primary font-bold" href="<?php echo e(route('admin.scanner')); ?>">
...
<script>
    ...
    const ROUTE_VERIFY  = '<?php echo e(route("admin.scanner.validate")); ?>';
...
</body></html><?php /**PATH D:\laragon\www\JVC26\gatemate\resources\views/admin/scanner.blade.php ENDPATH**/ ?>