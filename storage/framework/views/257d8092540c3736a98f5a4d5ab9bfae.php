...
<?php $__env->startSection('title', 'SecureGate - Temukan Event Terbaikmu'); ?>
    ...
    <div class="flex flex-col md:flex-row items-center gap-12">
        <div class="w-full md:w-1/2 flex flex-col items-start gap-6 z-10">
            ...
            <div class="flex flex-wrap gap-4 mt-2">
                <a href="<?php echo e(route('discover')); ?>" class="coral-pill px-[22px] py-[10px] bg-primary text-on-primary font-body-md text-body-md hover:opacity-90 active:scale-95 transition-all text-center">
                    Jelajahi Event
                </a>
                <a href="<?php echo e(route('signup')); ?>" class="coral-pill px-[22px] py-[10px] border border-primary text-primary font-body-md text-body-md hover:bg-surface-container-low active:scale-95 transition-all text-center">
                    Daftar Gratis
                </a>
            </div>
        </div>
...
<section class="bg-surface-container-lowest py-16">
    <div class="max-w-[1280px] mx-auto px-container-padding">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-gap-default">
            <!-- Category Item -->
            <a href="<?php echo e(route('discover', ['category' => 'Konser'])); ?>" class="group flex flex-col items-center gap-3 p-6 bg-white card-shadow rounded-[14px] hover:border-primary transition-all cursor-pointer">
            ...
            <a href="<?php echo e(route('discover', ['category' => 'Sport'])); ?>" class="group flex flex-col items-center gap-3 p-6 bg-white card-shadow rounded-[14px] hover:border-primary transition-all cursor-pointer">
                <div class="w-14 h-14 rounded-full bg-surface-container-low flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
            ...
            <a href="<?php echo e(route('discover', ['category' => 'Festival'])); ?>" class="group flex flex-col items-center gap-3 p-6 bg-white card-shadow rounded-[14px] hover:border-primary transition-all cursor-pointer">
                <div class="w-14 h-14 rounded-full bg-surface-container-low flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
            ...
            <a href="<?php echo e(route('discover', ['category' => 'Seminar'])); ?>" class="group flex flex-col items-center gap-3 p-6 bg-white card-shadow rounded-[14px] hover:border-primary transition-all cursor-pointer">
                <div class="w-14 h-14 rounded-full bg-surface-container-low flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
                    <span class="material-symbols-outlined text-3xl">school</span>
                </div>
                <span class="font-body-md text-body-md font-medium">Seminar</span>
            </a>
            <a href="<?php echo e(route('discover', ['category' => 'Pameran'])); ?>" class="group flex flex-col items-center gap-3 p-6 bg-white card-shadow rounded-[14px] hover:border-primary transition-all cursor-pointer">
                <div class="w-14 h-14 rounded-full bg-surface-container-low flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
            ...
            <a href="<?php echo e(route('discover', ['category' => 'Workshop'])); ?>" class="group flex flex-col items-center gap-3 p-6 bg-white card-shadow rounded-[14px] hover:border-primary transition-all cursor-pointer">
                <div class="w-14 h-14 rounded-full bg-surface-container-low flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
...
<section class="py-16 overflow-hidden">
    <div class="max-w-[1280px] mx-auto px-container-padding">
        <div class="flex justify-between items-center mb-8">
            ...
            <a class="font-label-md text-label-md text-primary hover:underline" href="<?php echo e(route('discover')); ?>">Lihat Semua</a>
        </div>
        <div class="flex gap-gap-default overflow-x-auto no-scrollbar pb-8 -mx-container-padding px-container-padding">
            <!-- Event Card 1 -->
            <a href="<?php echo e(route('discover')); ?>" class="min-w-[280px] md:min-w-[320px] bg-white rounded-[14px] overflow-hidden card-shadow group cursor-pointer hover:shadow-lg transition-shadow block">
...
<section class="bg-surface-container-low/30 py-20 border-y border-outline-variant/20">
    <div class="max-w-[1280px] mx-auto px-container-padding">
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            ...
            <a href="<?php echo e(route('organizer.register')); ?>" class="coral-pill px-8 py-3 border-2 border-primary text-primary font-body-md text-body-md hover:bg-primary hover:text-on-primary transition-all font-bold text-center">
...
<section class="max-w-[1280px] mx-auto py-16">
    <div class="bg-primary-container/20 rounded-3xl p-12 flex flex-col items-center text-center gap-6 border border-primary/10">
        ...
        <div class="flex gap-4">
            <a href="<?php echo e(route('discover')); ?>" class="coral-pill px-8 py-3 bg-primary text-on-primary font-body-md text-body-md hover:bg-primary/90 transition-all text-center">
                Mulai Sekarang
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\JVC26\gatemate\resources\views/welcome.blade.php ENDPATH**/ ?>