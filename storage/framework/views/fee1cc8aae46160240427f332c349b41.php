...
<aside class="w-sidebar-width h-screen fixed left-0 top-0 bg-surface border-r-[0.5px] border-outline-variant hidden md:flex flex-col py-page-padding z-40">
    ...
    <nav class="flex-1 space-y-1">
        <!-- Active Item -->
        <a class="flex items-center px-6 py-3 border-l-4 border-primary bg-primary-fixed text-primary font-bold transition-colors cursor-pointer" href="<?php echo e(route('admin.dashboard')); ?>">
            <span class="material-symbols-outlined mr-3">dashboard</span>
            <span class="font-body-sm text-body-sm">Dashboard</span>
        </a>
        <a class="flex items-center px-6 py-3 text-secondary hover:bg-surface-container-low transition-colors cursor-pointer active:opacity-80" href="<?php echo e(route('admin.events.index')); ?>">
            <span class="material-symbols-outlined mr-3">event</span>
            <span class="font-body-sm text-body-sm">Event Saya</span>
        </a>
        <a class="flex items-center px-6 py-3 text-secondary hover:bg-surface-container-low transition-colors cursor-pointer active:opacity-80" href="<?php echo e(route('admin.scanner')); ?>">
            <span class="material-symbols-outlined mr-3">qr_code_scanner</span>
            <span class="font-body-sm text-body-sm">Scanner</span>
        </a>
        <a class="flex items-center px-6 py-3 text-secondary hover:bg-surface-container-low transition-colors cursor-pointer active:opacity-80" href="<?php echo e(route('admin.finance')); ?>">
    ...
    <div class="px-6 mt-auto space-y-1">
        ...
        <div class="pt-4 border-t border-outline-variant flex items-center justify-between">
            <div class="flex items-center">
                <?php if(!empty($navPic)): ?>
                    <img alt="Organizer Profile" class="w-8 h-8 rounded-full object-cover bg-surface-container-high" src="<?php echo e(asset('Media/uploads/' . $navPic)); ?>"/>
                <?php else: ?>
                    <div class="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white font-bold text-sm"><?php echo e($navInitial); ?></div>
                <?php endif; ?>
                <div class="ml-2 overflow-hidden">
                    <p class="font-label-md text-label-md font-bold truncate"><?php echo e($adminName); ?></p>
                    <p class="font-caption text-caption text-secondary">ID: SG-<?php echo e($adminId); ?></p>
                </div>
            </div>
    ...
    <div class="max-w-max-container mx-auto p-page-padding space-y-stack-lg">
        ...
        <header class="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-4">
            <div>
                ...
                <p class="font-body-sm text-body-sm text-secondary">Selamat datang kembali, <span class="font-bold text-on-surface"><?php echo e($adminName); ?></span></p>
            </div>
            <div class="flex items-center gap-stack-sm">
                ...
                <a href="<?php echo e(route('admin.events.create')); ?>" class="flex items-center px-4 h-10 bg-primary text-on-primary rounded-lg font-label-md active:scale-95 transition-all shadow-sm">
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-gutter">
            ...
            <div class="bg-surface-container-lowest border-[0.5px] border-outline-variant p-stack-lg rounded-[14px]">
                <div class="flex justify-between items-start mb-4">
                    ...
                    <span class="text-secondary font-label-md">Aktif: <?php echo e($activeEvents); ?></span>
                </div>
                <p class="text-secondary font-label-md">Total Event</p>
                <p class="text-h2 font-h2 font-bold text-on-surface"><?php echo e($totalEvents); ?></p>
            </div>
            ...
            <div class="bg-surface-container-lowest border-[0.5px] border-outline-variant p-stack-lg rounded-[14px]">
                ...
                <p class="text-h2 font-h2 font-bold text-on-surface"><?php echo e(number_format($totalTicketsSold, 0, ',', '.')); ?></p>
            </div>
            ...
            <div class="bg-surface-container-lowest border-[0.5px] border-outline-variant p-stack-lg rounded-[14px]">
                ...
                <p class="text-h2 font-h2 font-bold text-primary">Rp <?php echo e(number_format($ticketRevenue, 0, ',', '.')); ?></p>
            </div>
            ...
            <div class="bg-surface-container-lowest border-[0.5px] border-outline-variant p-stack-lg rounded-[14px]">
                ...
                <p class="text-h2 font-h2 font-bold text-on-surface"><?php echo e($checkedInToday); ?></p>
            </div>
        </section>
            ...
            <div class="lg:col-span-4 bg-surface-container-lowest border-[0.5px] border-outline-variant rounded-[14px] flex flex-col overflow-hidden">
                ...
                <div class="p-6 flex-1 space-y-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-body-sm font-medium">Rp <?php echo e(number_format($ticketRevenue, 0, ',', '.')); ?></span>
                    </div>
                    <div class="flex justify-between items-center text-error">
                        <span class="text-secondary font-body-sm">Service Fee (<?php echo e($feePercent ?? 10); ?>%)</span>
                        <span class="font-body-sm font-medium">- Rp <?php echo e(number_format($platformFeeTotal, 0, ',', '.')); ?></span>
                    </div>
                    <div class="flex justify-between items-center text-tertiary">
                        <span class="text-secondary font-body-sm">Tenant Cut</span>
                        <span class="font-body-sm font-medium">+ Rp <?php echo e(number_format($tenantCutTotal ?? 0, 0, ',', '.')); ?></span>
                    </div>
                    <div class="pt-4 border-t border-outline-variant flex justify-between items-center">
                        ...
                        <span class="text-primary font-h2 font-bold">Rp <?php echo e(number_format($netIncomeTotal, 0, ',', '.')); ?></span>
                    </div>
                </div>
                <div class="p-6 pt-0">
                    <button class="w-full h-12 bg-on-surface text-surface rounded-lg font-label-md active:opacity-80 transition-opacity flex items-center justify-center">
                        Ajukan Penarikan (Tersedia: Rp <?php echo e(number_format($sisaBisaDitarikTotal, 0, ',', '.')); ?>)
                    </button>
                    <p class="text-center text-caption text-secondary mt-3 italic">
                        Penarikan terakhir: <?php echo e($withdrawalHistory->first() ? $withdrawalHistory->first()->created_at->format('d M Y') : '-'); ?>
            ...
            <div class="lg:col-span-8 bg-surface-container-lowest border-[0.5px] border-outline-variant rounded-[14px] p-6 flex flex-col">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <select class="bg-surface border-outline-variant rounded-md text-label-md py-1 px-3 outline-none focus:border-primary">
                        <option>Tahun <?php echo e(date('Y')); ?></option>
                    </select>
                </div>
                <div class="flex-1 relative min-h-[200px] flex items-end justify-between gap-2 px-2 chart-container">
                    ...
                    <div class="absolute top-2 right-4 bg-[#1b1c1c] text-white p-2 rounded-md shadow-xl flex items-baseline gap-2 z-10">
                        <span class="font-bold text-sm"><?php echo e(formatShort($latestRevenue)); ?></span>
                        <span class="text-[10px] text-secondary-fixed-dim"><?php echo e($months[$latestMonthIdx] ?? 'Bulan Ini'); ?></span>
                    </div>
                    ...
                    <div class="absolute bottom-0 w-full flex justify-around px-2 text-caption text-secondary">
                        <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($idx == $latestMonthIdx): ?>
                                <span class="font-bold text-on-surface"><?php echo e(explode(' ', $m)[0]); ?></span>
                            <?php else: ?>
                                <span><?php echo e(explode(' ', $m)[0]); ?></span>
                            <?php endif; ?>
        ...
        <section class="bg-surface-container-lowest border-[0.5px] border-outline-variant rounded-[14px] overflow-hidden mb-12">
            <div class="px-6 py-4 border-b-[0.5px] border-outline-variant flex justify-between items-center">
                ...
                <a class="text-primary font-label-md hover:underline" href="<?php echo e(route('admin.events.index')); ?>">Lihat Semua</a>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-body-sm">
                        ...
                        <tr class="border-b-[0.5px] border-outline-variant hover:bg-surface-container-low/50 transition-colors">
                            <td class="px-6 py-4 font-medium"><?php echo e($event->title); ?></td>
                            <td class="px-6 py-4 text-secondary"><?php echo e(\Carbon\Carbon::parse($event->start_date)->format('d M Y')); ?></td>
                            <td class="px-6 py-4">
                                <div class="w-full bg-surface-container-high h-1.5 rounded-full overflow-hidden">
                                    <div class="bg-primary h-full" style="width: <?php echo e($percentage); ?>%"></div>
                                </div>
                                <span class="text-caption mt-1 inline-block"><?php echo e($sold); ?>/<?php echo e($capText); ?></span>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <a href="<?php echo e(route('admin.events.show', $event->id_event)); ?>" class="text-primary active:opacity-70">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-8 text-center text-secondary">Belum ada event. <a href="<?php echo e(route('admin.events.create')); ?>" class="text-primary hover:underline">Buat event pertama Anda.</a></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<nav class="fixed bottom-0 w-full z-50 md:hidden bg-surface border-t-[0.5px] border-outline-variant flex justify-around items-center h-16 pb-safe">
    <a class="flex flex-col items-center text-primary font-bold active:bg-surface-container-low px-4 py-1 transition-colors" href="<?php echo e(route('admin.dashboard')); ?>">
        <span class="material-symbols-outlined">grid_view</span>
        <span class="font-label-md text-label-md">Dashboard</span>
    </a>
    <a class="flex flex-col items-center text-secondary active:bg-surface-container-low px-4 py-1 transition-colors" href="<?php echo e(route('admin.events.index')); ?>">
        <span class="material-symbols-outlined">confirmation_number</span>
        <span class="font-label-md text-label-md">Events</span>
    </a>
    <a class="flex flex-col items-center text-secondary active:bg-surface-container-low px-4 py-1 transition-colors" href="<?php echo e(route('admin.scanner')); ?>">
    ...
    <a class="flex flex-col items-center text-secondary active:bg-surface-container-low px-4 py-1 transition-colors" href="<?php echo e(route('admin.finance')); ?>">
...
<?php /**PATH D:\laragon\www\JVC26\gatemate\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>