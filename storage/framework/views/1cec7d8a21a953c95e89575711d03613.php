...
<a href="<?php echo e(route('signup')); ?>" class="font-body-md text-body-md text-primary font-bold">Daftar Sekarang</a>
</div>
</nav>
</header>
...
<a href="<?php echo e(url('/auth/google')); ?>" class="flex items-center justify-center gap-2 py-3 border border-outline-variant rounded-xl hover:bg-surface-container-low transition-colors active:scale-95">
...
<!-- Login Form -->
<form class="space-y-5" action="<?php echo e(route('signin.process')); ?>" method="POST">
<?php echo csrf_field(); ?>
<div class="space-y-1.5">
<label class="font-label-md text-label-md text-on-surface-variant ml-1">Email</label>
<input class="w-full h-12 px-4 input-base text-body-md" name="email" value="<?php echo e(old('email')); ?>" placeholder="nama@email.com" required="" type="email">
</div>
<div class="space-y-1.5">
...
<p class="mt-8 text-center font-body-md text-body-md text-on-surface-variant">
                        Belum punya akun? 
                        <a class="text-primary font-bold hover:underline" href="<?php echo e(route('signup')); ?>">Daftar Sekarang</a>
</p>
</div>
</div>
</div>
...
</body></html><?php /**PATH D:\laragon\www\JVC26\gatemate\resources\views/auth/signin.blade.php ENDPATH**/ ?>