...
export default function AdminFinancePage() {
  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen flex" style={{ fontFamily: "'Inter', sans-serif" }}>
      <OrganizerSidebar activeNav="finance" />

      {/* Main Content */}
      <main className="md:ml-[240px] min-h-screen pt-16 md:pt-0 pb-20 md:pb-10 w-full relative">
      ...
      <nav className="fixed bottom-0 w-full z-50 md:hidden bg-surface border-t-[0.5px] border-outline-variant flex justify-around items-center h-16 pb-safe">
        ...
        <Link to="/organizer/finance" className="flex flex-col items-center text-primary font-bold active:bg-surface-container-low px-4 py-1 transition-colors">
