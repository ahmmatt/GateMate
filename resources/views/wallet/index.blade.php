            ...
            <div class="lg:col-span-8 flex flex-col gap-gap-default">
                ...
                <div class="bg-brand-coral rounded-[22px] p-8 text-white relative overflow-hidden flex flex-col gap-6 shadow-sm" style="--x: 541px; --y: 170px;">
                    ...
                    <div class="z-10">
                        ...
                        <h1 class="font-headline-lg text-headline-lg font-bold">Rp {{ number_format($user->wallet_balance, 0, ',', '.') }}</h1>
                    </div>
                    <div class="flex z-10">
                        ...
                        @forelse($transactions as $tx)
                            ...
                            <div class="flex items-center justify-between py-4 border-b border-[#EBEBEB] hover:bg-[#F9F9F9] transition-colors px-2 -mx-2 rounded-lg">
                                <div class="flex items-center gap-4">
                                    ...
                                    @endif
                                    <div>
                                        <p class="font-body-lg text-body-lg font-medium text-on-surface">{{ $txName }}</p>
                                        <p class="font-caption text-caption text-secondary">{{ $tx->created_at->format('d M Y, H:i') }}</p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="font-body-lg text-body-lg font-bold {{ $isIncome ? 'text-[#2E7D32]' : 'text-brand-coral' }}">
                                        {{ $isIncome ? '+' : '-' }}Rp {{ number_format($tx->amount, 0, ',', '.') }}
                                    </p>
                                    <p class="font-caption text-caption text-secondary" style="text-transform: capitalize;">{{ $tx->status }}</p>
                                </div>
                            </div>
                        @empty
            ...
            <div class="lg:col-span-4 flex flex-col gap-gap-default">
                ...
                <div class="bg-surface-container-lowest rounded-card border border-[#EBEBEB] p-4 flex flex-col gap-4">
                    ...
                    <div class="rounded-lg overflow-hidden relative aspect-[16/9]">
                        <img alt="Concert Promo" class="w-full h-full object-cover" src="{{ asset('Media/09071799-7231-4faa-883e-a1eb2d01ef9b.avif') }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium text-on-surface">Rp {{ number_format($user->wallet_balance, 0, ',', '.') }}</span>
                            </div>
                        </div>
                    </div>
