...
file_path = r'd:\laragon\www\JVC26\gatemate\resources\views\auth\signin.blade.php'

content = r"""<!DOCTYPE html><html class="light" lang="id" style=""><head>
<meta charset="utf-8">
...
print("done patching signin blade")
