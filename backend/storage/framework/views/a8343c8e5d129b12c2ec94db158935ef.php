...
<div class="container">
    ...
    <div class="ticket-body">
        ...
        <div class="event-hero">
            ...
            <div class="event-name"><?php echo e($transaction->event->title ?? 'Event SecureGate'); ?></div>
        </div>
    ...
    <div class="footer">
        ...
        <p style="margin-top:8px; color:#334155;">
            © <?php echo e(date('Y')); ?> SecureGate · Tiket Aman, Acara Lancar.
        </p>
    </div>
...
<?php /**PATH D:\laragon\www\JVC26\gatemate\resources\views/emails/eticket.blade.php ENDPATH**/ ?>