...
<div class="container">
    ...
    <div class="ticket-body">
        ...
        <div class="event-hero">
            <div class="event-tag"><?php echo e($transaction->event->category ?? 'Event'); ?></div>
            <div class="event-name"><?php echo e($transaction->event->title ?? 'Event GateMate'); ?></div>
        </div>
        ...
        <div class="info-section">
            <p class="greeting">
                Halo, <strong><?php echo e($transaction->user->full_name ?? 'Peserta'); ?></strong>! 🎉<br>
            ...
            <div class="info-grid">
                <div class="info-row">
                    ...
                    <div class="info-value mono"><?php echo e($transaction->order_id); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Nama Pemesan</div>
                    <div class="info-value"><?php echo e($transaction->user->full_name ?? '—'); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Event</div>
                    <div class="info-value"><?php echo e($transaction->event->title ?? '—'); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Tanggal</div>
                    <div class="info-value">
                        <?php if($transaction->event && $transaction->event->start_date): ?>
                            <?php echo e(\Carbon\Carbon::parse($transaction->event->start_date)->translatedFormat('d F Y')); ?>
                ...
                <div class="info-row">
                    ...
                    <div class="info-value green"><?php echo e($transaction->ticketTier->tier_name ?? '—'); ?></div>
                </div>
                <div class="info-row">
        ...
        <div class="cta-section">
            ...
            <a href="<?php echo e(route('ticket.qrcode', $transaction->id)); ?>" class="btn-ticket">
    ...
    <div class="footer">
        ...
        <p style="margin-top:8px; color:#334155;">
            © <?php echo e(date('Y')); ?> GateMate · Tiket Aman, Acara Lancar.
        </p>
    </div>
...
<?php /**PATH D:\laragon\www\JVC26\gatemate\backend\resources\views/emails/eticket.blade.php ENDPATH**/ ?>